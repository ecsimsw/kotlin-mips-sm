...
class ALU(
    ...
    init {
        ...
        operations[Opcode.LOAD_WORD] = { op1, op2 -> registers.r[0] = memory[value(op1)] }
        operations[Opcode.STORE_WORD] = { op1, op2 -> memory[value(op2)] = value(op1) }
